...
give @s minecraft:potion[minecraft:custom_data="{life_potion:1}",minecraft:hide_additional_tooltip={},minecraft:potion_contents={potion:"minecraft:thick",custom_color:16660932}]
