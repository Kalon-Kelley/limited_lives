...
execute as @e[type=minecraft:item_frame,tag=align,limit=1,distance=..1] at @s if entity @e[type=minecraft:marker,tag=potion_marker,distance=..0.4] run return run kill @s
$say $(info)
